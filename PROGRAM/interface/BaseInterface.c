...
ref GetQuestTextFileName()
{
	...
	questTextFileName[3] = "PROGRAM\QuestBook\QuestBook_Events.txt"; // ивенты
	questTextFileName[4] = "PROGRAM\QuestBook\QuestBook_MythsAndLegends.txt"; // мифы и легенды
    questTextFileName[5] = "PROGRAM\QuestBook\QuestBook_Documents.txt"; // документы
...
void InitInterfaceTables()
{
	...
	Interfaces[INTERFACE_CHARACTER_ALL].SectionName = "interface\new_characters.c";	// character_all.c";
	Interfaces[INTERFACE_CHARACTER_ALL].IniFile = "RESOURCE\INI\INTERFACES\New_Characters.ini";	// LSCchar_all.ini";

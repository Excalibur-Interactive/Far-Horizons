...
// World map ===================================================================
	...
	// evganat - добавляем FCX в интерфейс инвентаря
	CI_CreateAndSetControls( "", "InterfaceF", CI_GetKeyCode("KEY_F"), 0, false );
	CI_CreateAndSetControls( "", "InterfaceC", CI_GetKeyCode("KEY_C"), 0, false );
	CI_CreateAndSetControls( "", "InterfaceX", CI_GetKeyCode("KEY_X"), 0, false );

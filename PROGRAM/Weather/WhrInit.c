...
{	
	...
	n = Whr_InitStdWeather( n, 		"5 Hour",	5.00,	5.99,		"night5",	"storm",	"n",	0,	0,	0,	1,	1,	1,	1,	1,	0, 		"05", 	1, 	1,	1,	0 );	
	...
	n = Whr_InitStdWeather( n, 	   "21 Hour",  21.00,  21.99,    "evening21", "evening",	"e",	0,	0,	0,	1,	1,	1,	0,	0,	0, 		"21", 	1, 	1,	0,	0 );
	n = Whr_InitStdWeather( n, 	   "22 Hour",  22.00,  22.99,    "evening22", "evening",	"e",	0,	0,	0,	1,	1,	1,	0,	0,	0, 		"22", 	1, 	1,	0,	0 );
	n = Whr_InitStdWeather( n, 	   "23 Hour",  23.00,  23.99,    "evening23", "evening",	"e",	0,	0,	0,	1,	1,	1,	1,	1,	0, 		"23", 	1, 	1,	0,	0 );	
						...
						bool	sunFlares)
{
	...
	whr.Sun.Overflow.Enable 		= true;
	whr.Sun.Overflow.Texture 		= "weather\lightning\flash.tga";
	...
	whr.Sun.Reflection.Enable 		= true;
	...
	if(_storm)
	{
		...
		whr.Fog.Height 						= 700;
		whr.Fog.Start 						= 0;
		whr.Fog.Density 					= 0.015;
		whr.Fog.IslandDensity 				= 0.006;
		whr.Fog.SeaDensity 					= 0.0006;
	...
	switch (id)
	{
		// night (0 - 5)
		case "0 Hour" 			:
			whr.Sun.Color 						= argb(  0, 30, 30, 30 );
			whr.Sun.Ambient 					= argb(  0, 28, 28, 28 );
			whr.Fog.Color 						= argb(  0,  6, 13, 23 );
			                            
			whr.Shadow.Density.Head 			= argb(255, 46, 46, 46 );
			whr.Shadow.Density.Foot 			= argb(255, 46, 46, 44 );
		break;
		...
		case "3 Hour" 			:
			...
			whr.Sun.Ambient 					= argb(  0, 30, 30, 30 );
		...
		case "4 Hour" 			:
			whr.Sun.Color 						= argb(  0, 30, 30, 25 );
			whr.Sun.Ambient 					= argb(  0, 48, 48, 48 );			
		...
		case "5 Hour" 			:
			whr.Sun.Color 						= argb(  0, 30, 30, 25 );
			whr.Sun.Ambient 					= argb(  0, 58, 58, 58 );
		...
		// morning (6 - 10)
		case "6 Hour" 			:
			whr.Sun.Color 						= argb(  0,110, 90, 90 );
			whr.Sun.Ambient 					= argb(  0,155,115, 80 );
		...
		case "8 Hour" 			:
			whr.Sun.Color 						= argb(  0,120, 90,100 );
			whr.Sun.Ambient 					= argb(  0,128,128,128 );
		...
		case "9 Hour" 			:			
			whr.Sun.Color 						= argb(  0,160,120, 80 );
			whr.Sun.Ambient 					= argb(  0,128,128,128 );
		...
		case "10 Hour" 			:
			whr.Sun.Color 						= argb(  0,255,255,255 );
			whr.Sun.Ambient 					= argb(  0,128,128,128 );
			whr.Fog.Color 						= argb(  0,193,218,228 );							
		...
		// day (11 - 18)
		case "11 Hour" 			:			
			whr.Sun.Color 						= argb(  0,220,210,200 );
			whr.Sun.Ambient 					= argb(  0,128,128,128 );
			whr.Fog.Color 						= argb(  0,193,218,228 );	
		...
		case "12 Hour" 			:			
			whr.Sun.Color 						= argb(  0,230,230,200 );
			whr.Sun.Ambient 					= argb(  0,128,128,128 );
			whr.Fog.Color 						= argb(  0,193,218,228 );			
			whr.Rain.DropsColor 				= argb( 63,255,255,255 );	
		break;	
		...
		case "13 Hour" 			:
			whr.Sun.Color 						= argb(  0,214,214,208 );
			whr.Sun.Ambient 					= argb(  0,128,128,128 );
			whr.Fog.Color 						= argb(  0,193,218,228 );	
			whr.Rain.DropsColor 				= argb( 63,255,255,255 );	
		break;	
		...
		case "14 Hour" 			:
			whr.Sun.Color 						= argb(  0,234,234,218 );
			whr.Sun.Ambient 					= argb(  0,128,128,128 );
			whr.Fog.Color 						= argb(  0,193,218,228 );				
			whr.Rain.DropsColor 				= argb( 63,255,255,255 );		
		break;	
		...
		case "15 Hour" 			:
			whr.Sun.Color 						= argb(  0,226,224,204 );
			whr.Sun.Ambient 					= argb(  0,128,128,128 );
			whr.Fog.Color 						= argb(  0,193,218,228 );	
			whr.Rain.DropsColor 				= argb( 63,255,255,255 );	
		break;	
		...
		case "16 Hour" 			:
			whr.Sun.Color 						= argb(  0,166,154,144 );
			whr.Sun.Ambient 					= argb(  0,128,128,128 );
			whr.Fog.Color 						= argb(  0,193,218,228 );	
			whr.Rain.DropsColor 				= argb( 63,255,255,255 );		
		break;	
		...
		case "17 Hour" 			:
			whr.Sun.Color 						= argb(  0,136,134,124 );
			whr.Sun.Ambient 					= argb(  0,128,128,128 );
		...
		case "18 Hour" 			:
			whr.Sun.Color 						= argb(  0,126,124,114 );
			whr.Sun.Ambient 					= argb(  0,128,128,128 );
		...
		// evening (19 - 23)
		case "19 Hour" 			:
			whr.Sun.Color 						= argb(  0,120,122,122 );
			whr.Sun.Ambient 					= argb(  0,155,115, 80 );
			...
			whr.Shadow.Density.Head 			= argb(255,  6,  6,  6 );
			whr.Shadow.Density.Foot 			= argb(255, 36, 36, 34 );
		break;	

		case "20 Hour" 			:
			whr.Sun.Color 						= argb(  0,135,120,115 );
			whr.Sun.Ambient 					= argb(  0, 48, 48, 48 );
		...
		case "Storm04"			:
			...
			whr.Sun.Color 						= argb(  0, 30, 30, 15 );
			whr.Sun.Ambient 					= argb(  0, 45, 45, 45 );
		break;
		...
		case "Storm05"			:
			...
			whr.Sun.Color 						= argb(  0, 30, 30, 15 );
			whr.Sun.Ambient 					= argb(  0, 55, 55, 55 );
		break;
		...
		case "Storm06"			:
			...
			whr.Rainbow.Enable 					= true;

			whr.Sun.Color 						= argb(  0, 60, 60, 60 );
			whr.Sun.Ambient 					= argb(  0,105,105,105 );
		break;

						...
						bool	sunFlares)
{
	...
	switch (id)
	{
		...
		case "0 Hour" 			:
			...
			whr.Sun.Ambient 					= argb(  0, 25, 25, 25 );
            whr.Sun.SeaColor 					= argb(  0, 55, 55, 55 );
			whr.Sun.SeaAmbient 					= argb(  0, 30, 30, 30 );
		...
		case "4 Hour" 			:
			whr.Sun.Color 						= argb(  0, 45, 45, 44 );
			whr.Sun.Ambient 					= argb(  0, 38, 38, 38 );			
            whr.Sun.SeaColor 					= argb(  0, 55, 55, 55 );
			whr.Sun.SeaAmbient 					= argb(  0, 38, 38, 38 );
			whr.Fog.Color 						= argb(  0,  5, 13, 26 );
			whr.Rain.DropsColor 				= argb( 43,255,255,255 );
		break;	

		case "5 Hour" 			:
			whr.Sun.Color 						= argb(  0, 50, 50, 49 );

void InitIslands()
{
	...
	/////////////////////////////////////////////////////////////////////////
		...
		Islands[n].Trade.Import.id3 = GOOD_BRICKS;
		Islands[n].Trade.Import.id4 = GOOD_CITRUSES;
		...
		Islands[n].Trade.Contraband.id3 = GOOD_CACAO;
	...
	/////////////////////////////////////////////////////////////////////////
		...
		// Islands[n].net.fort.l1..lxx -
        // boal 16.04.04 -->
		Islands[n].Trade.Export.id2 = GOOD_BRICKS;
        ...
        Islands[n].Trade.Contraband.id4 = GOOD_CACAO;
	...
	/////////////////////////////////////////////////////////////////////////
		...
		Islands[n].Trade.Import.id2 = GOOD_BRICKS;
		Islands[n].Trade.Import.id3 = GOOD_CITRUSES;
	...
	/////////////////////////////////////////////////////////////////////////
		...
		Islands[n].Trade.Export.id2 = GOOD_CITRUSES;
		Islands[n].Trade.Export.id3 = GOOD_CACAO;
	...
	/////////////////////////////////////////////////////////////////////////
		...
		Islands[n].Trade.Import.id6 = GOOD_CACAO;
	...
	/////////////////////////////////////////////////////////////////////////
		...
		Islands[n].reload.l4.tex = "t1";
        // boal 16.04.04 -->
        Islands[n].Trade.Export.id1 = GOOD_CACAO;
		Islands[n].Trade.Export.id2 = GOOD_PLANKS;
		...
		Islands[n].Trade.Import.id5 = GOOD_BRICKS;
	...
	/////////////////////////////////////////////////////////////////////////
		...
		Islands[n].Trade.Import.id5 = GOOD_CACAO;
	...
	/////////////////////////////////////////////////////////////////////////
		...
		Islands[n].Trade.Import.id4 = GOOD_SILK;
		Islands[n].Trade.Import.id5 = GOOD_CITRUSES;
	...
	/////////////////////////////////////////////////////////////////////////
		...
		Islands[n].Trade.Export.id3 = GOOD_BRICKS;
	...
	/////////////////////////////////////////////////////////////////////////
		...
		Islands[n].Trade.Contraband.id1 = GOOD_SLAVES;
		Islands[n].Trade.Contraband.id2 = GOOD_PLANKS;
		Islands[n].Trade.Contraband.id3 = GOOD_CITRUSES;
	...
	/////////////////////////////////////////////////////////////////////////
		...
		Islands[n].Trade.Export.id4 = GOOD_CACAO;
		Islands[n].Trade.Export.id5 = GOOD_CINNAMON;
		Islands[n].Trade.Export.id7 = GOOD_FOOD;

		Islands[n].Trade.Import.id1 = GOOD_CITRUSES;
		Islands[n].Trade.Import.id2 = GOOD_MEDICAMENT;
		Islands[n].Trade.Import.id3 = GOOD_SAILCLOTH;
	...
	/////////////////////////////////////////////////////////////////////////
		...
		Islands[n].Trade.Contraband.id1 = GOOD_SLAVES;
		Islands[n].Trade.Contraband.id2 = GOOD_BRICKS;
		Islands[n].Trade.Contraband.id3 = GOOD_COPRA;
        Islands[n].Trade.Contraband.id4 = GOOD_CITRUSES;
	...
	/////////////////////////////////////////////////////////////////////////
		...
		Islands[n].Trade.Export.id2 = GOOD_CACAO;
	...
	/////////////////////////////////////////////////////////////////////////
		...
		Islands[n].Trade.Import.id4 = GOOD_CACAO;
        ...
        Islands[n].Trade.Contraband.id5 = GOOD_CITRUSES;
        // boal 16.04.04 <--
		Islands[n].InterfaceTextures.t1 = "battle_interface\moor_7.tga";
		Islands[n].InterfaceTextures.t1.h = 4;
		Islands[n].InterfaceTextures.t1.v = 1;
	...
	/////////////////////////////////////////////////////////////////////////
		...
		Islands[n].Trade.Import.id4 = GOOD_PAPRIKA;
		Islands[n].Trade.Import.id5 = GOOD_TOBACCO;
		Islands[n].Trade.Import.id7 = GOOD_CACAO;

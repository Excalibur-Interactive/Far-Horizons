void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Node_3":
			...
			{
				bOk = makeint(pchar.reputation) < 51 && makeint(pchar.reputation) > 41;
		...
		case "GetLost":
			...
			dialog.text = LinkRandPhrase("Что тебе нужно? Мы же договорились, что ты уходишь!",
				...
				"Уходи, "+ GetSexPhrase("приятель","подруга") +"! Черт возьми, неужели ты всё-таки хочешь отдать свои деньги?");
			Link.l1 = "Да, я уже ухожу.";
			Link.l1.go = "Exit";

...
//================ METRO ====================
        ...
        case "goodsIDX1":
			...
			dialog.Text = XI_ConvertString(Goods[sti(Pchar.quest.Contraband.ChooseGoodsID)].name) + "? Цена " + Pchar.quest.Contraband.ChooseGoodsPrice +" песо за "+ Pchar.quest.Contraband.ChooseGoodsUnit+" шт. Давай посмотрим, сколько у тебя этого груза.";
			Link.l1 = "Давай.";
		...
		case "Make_trade_Edit2":
			...
			else
			{
				...
				dialog.Text = "Итого: " + Pchar.quest.Contraband.ChooseGoodsQty + " шт. за "+ pchar.quest.contraband.sum + " песо. Идет?";
				Link.l1 = "Да, вполне.";

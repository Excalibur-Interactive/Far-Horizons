...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "sailor_pier5":
			dialog.text = "Так точно, мы запомним... Ну, так что, капитан, вы позволите нам побыть в городе пару деньков? Чтобы мы могли как следует покувырк... Э-э-э-м... Отдохнуть. А затем снова в бой!";

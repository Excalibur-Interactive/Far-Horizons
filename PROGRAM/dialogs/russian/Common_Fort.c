			...
			else
			{
				...
				else
				{
					...
					switch (rand(10))
					{
						...
						case 6: ////////////////////////////////////////////
							dialog.text = "Аккуратнее здесь, это форт! Веди себя тише воды...";
						...
						case 8://///////////////////////////////////////////
							dialog.text = ""+ GetSexPhrase("Эх, и скука же в гарнизоне, вокруг одни неотесанные мужланы вроде тебя! А вот городской гарнизон жирует...","Эй, красавица! Как насчёт того, чтобы немного пофлиртовать с бравым воякой?") +"";
